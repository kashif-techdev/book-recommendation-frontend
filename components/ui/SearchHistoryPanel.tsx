  ...
  return (
    <section className={cn('w-full', className)}>
      <div className="overflow-hidden rounded-3xl border border-primary-100/70 bg-white/90 shadow-[0_18px_50px_-28px_rgba(79,70,229,0.45)] backdrop-blur-sm">
        ...
        {(!collapsibleDesktop || isDesktopExpanded) && (
        ...
        {collapsibleDesktop && !isDesktopExpanded && (
          <div className="hidden lg:block px-4 pb-4">
            <p className="rounded-xl border border-dashed border-primary-100 bg-primary-50/40 px-3 py-2 text-xs text-primary-700">
              Click the arrow to reveal your history.
            </p>
          </div>
        )}
      </div>
